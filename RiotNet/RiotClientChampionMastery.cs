...
namespace RiotNet
{
    ...
    public partial class RiotClient
    {
        ...
        /// <param name="token">The cancellation token to cancel the operation.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        public Task<ChampionMastery> GetChampionMasteryAsync(string summonerId, long championId, string platformId = null, CancellationToken token = default(CancellationToken))
        {
        ...
        /// <param name="token">The cancellation token to cancel the operation.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        public Task<List<ChampionMastery>> GetChampionMasteriesAsync(string summonerId, string platformId = null, CancellationToken token = default(CancellationToken))
        {
        ...
        /// <param name="token">The cancellation token to cancel the operation.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        public Task<int> GetChampionMasteryScoreAsync(string summonerId, string platformId = null, CancellationToken token = default(CancellationToken))
        {
