...
#if DB_READY
        /// <summary>
        /// Gets or sets the ID of the current <see cref="TeamStatDetail"/>. This does NOT come from the Riot API; it is used as a key when storing this object in a database.
        /// </summary>
        [Key]
